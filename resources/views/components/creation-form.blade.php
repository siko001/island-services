<form action="{{ route('tenancy.store') }}" enctype="multipart/form-data" method="POST" class="mt-4 w-full max-w-[350px]">
    @csrf
    <div class="mb-4">
        <label for="tenant_id" class="block text-sm font-medium dark:text-gray-200 text-gray-700">Application Name <sup class="text-red-500">*</sup></label>
    ...
    <div class="mb-4">
        <label for="admin_email" class="block text-sm font-medium dark:text-gray-200 text-gray-700">Super Admin Email <sup class="text-red-500">*</sup></label>
    ...
    <div class="mb-4">
        <label for="admin_password" class="block text-sm font-medium dark:text-gray-200 text-gray-700"> Super Admin Password <sup class="text-red-500">*</sup> </label>
    ...
    <div class="mb-4">
        ...
        <input type="file" name="logo_path" id="logo_path" accept="image/png, image/jpeg" class="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
    </div>
