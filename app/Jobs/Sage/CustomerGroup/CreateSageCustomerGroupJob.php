...
class CreateSageCustomerGroupJob implements ShouldQueue
{
    ...
    {
        try {
            $sageService->createInSage($this->customerGroup);
        } catch(Throwable $e) {
            Log::error('Create Sage Customer Group Job failed: ' . $e->getMessage(), [
